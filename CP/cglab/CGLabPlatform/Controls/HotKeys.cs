...
namespace CGLabPlatform{
    ...
    public class Hotkey : IMessageFilter{
        public static void Register(HotkeyType type, Control control, KeyMod mod, Keys key,
        ...
        [XmlIgnore] private bool enabled;
        ...
        public bool PreFilterMessage(ref Message message){
            ...
            switch (type){
                case HotkeyType.System:
                    return message.Msg == WM_HOTKEY &&
                           registered && message.WParam.ToInt32() == id
                           && OnPressed();

                case HotkeyType.Window:
                    return (message.Msg == WM_KEYDOWN || message.Msg == WM_SYSKEYDOWN)
                           && message.WParam.ToInt32() == (int) keyCode && alt == (GetKeyState(VK_MENU) >> 15 != 0)
                           && control == (GetKeyState(VK_CONTROL) >> 15 != 0) &&
                           shift == (GetKeyState(VK_SHIFT) >> 15 != 0)
