...
namespace CGLabPlatform{
    public class MouseExEventArgs{
        ...
        /// </summary>
        public int DistanceX => Location.X - PressedLocation.X;
        ...
        /// </summary>
        public double MovDelta => Math.Sqrt(MovDeltaX * MovDeltaX + MovDeltaY * MovDeltaY);

        public double RotAngle =>
            180.0 / Math.PI * (Math.Atan2(X - PressedLocation.X, Y - PressedLocation.Y) -
    ...
    public abstract class DrawDevice<A> : UserControl where A : IDeviceUpdateArgs{
        ...
        protected override void OnMouseDown(MouseEventArgs e){
            switch (e.Button){
                case MouseButtons.Left:
                    _argsLBM.Init(e);
                    MouseLeftBtnDown(this, _argsLBM.Update(e));
                    break;
                ...
                case MouseButtons.Right:
                    _argsRMB.Init(e);
                    MouseRightBtnDown(this, _argsRMB.Update(e));
                    break;
            }
        ...
        protected override void OnMouseUp(MouseEventArgs e){
            switch (e.Button){
                case MouseButtons.Left:
                    _argsLBM._IsPressed = false;
                    MouseLeftBtnUp(this, _argsLBM.Update(e));
                    break;
                case MouseButtons.Middle:
                    _argsMMB._IsPressed = false;
                    break;
                case MouseButtons.Right:
                    _argsRMB._IsPressed = false;
                    MouseRightBtnUp(this, _argsRMB.Update(e));
                    break;
            }
