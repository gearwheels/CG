...
namespace SharpGL{
    ...
    internal class FontOutlineEntry{
        ...
        /// The extrusion.
        /// </value>
        public float Extrusion{ get; set; }
        ...
        /// </value>
        public FontOutlineFormat FontOutlineFormat{ get; set; }
        ...
        /// The glyph metrics.
        /// </value>
        public GLYPHMETRICSFLOAT[] GlyphMetrics{ get; set; }
    }
    ...
    public class FontOutlines{
        private FontOutlineEntry CreateFontOutlineEntry(OpenGL gl, string faceName, int height,
            ...
            var hFont = Win32.CreateFont(height, 0, 0, 0, Win32.FW_DONTCARE, 0, 0, 0, Win32.DEFAULT_CHARSET,
                Win32.OUT_OUTLINE_PRECIS, Win32.CLIP_DEFAULT_PRECIS, Win32.CLEARTYPE_QUALITY, Win32.VARIABLE_PITCH,
                faceName);
            ...
            var result = Win32.wglUseFontOutlines(gl.RenderContextProvider.DeviceContextHandle, 0, 255, listBase,
        ...
        public void DrawText(OpenGL gl, string faceName, float fontSize, float deviation, float extrusion, string text,
            ...
            if (fontOutlineEntry == null)
                fontOutlineEntry = CreateFontOutlineEntry(gl, faceName, fontHeight, deviation, extrusion,
