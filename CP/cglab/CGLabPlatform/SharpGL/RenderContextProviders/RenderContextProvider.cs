...
namespace SharpGL.RenderContextProviders{
    public abstract class RenderContextProvider : IRenderContextProvider{
        ...
        /// <returns></returns>
        public virtual bool Create(OpenGLVersion openGLVersion, OpenGL gl, int width, int height, int bitDepth,
            object parameter){
        ...
        /// </summary>
        public OpenGLVersion RequestedOpenGLVersion => requestedOpenGLVersion;

        /// <summary>
        /// Gets the OpenGL version that is supported by the render context, compare to <see cref="RequestedOpenGLVersion"/>.
        /// </summary>
        public OpenGLVersion CreatedOpenGLVersion => createdOpenGLVersion;
