...
namespace SharpGL.RenderContextProviders{
    public class HiddenWindowRenderContextProvider : RenderContextProvider{
        ...
        /// <returns></returns>
        public override bool Create(OpenGLVersion openGLVersion, OpenGL gl, int width, int height, int bitDepth,
            object parameter){
            //  Call the base.
            ...
            wndClass.Init();
            wndClass.style = Win32.ClassStyles.HorizontalRedraw | Win32.ClassStyles.VerticalRedraw |
                             Win32.ClassStyles.OwnDC;
            ...
            if (Win32.SetPixelFormat(deviceContextHandle, iPixelformat, pfd) == 0) return false;
