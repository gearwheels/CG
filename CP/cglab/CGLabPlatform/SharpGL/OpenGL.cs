...
namespace SharpGL{
    ...
    public partial class OpenGL{
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glBitmap(int width, int height, float xorig, float yorig, float xmove, float ymove,
            byte[] bitmap);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glColorPointer(int size, uint type, int stride, short[] pointer);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glColorPointer(int size, uint type, int stride, int[] pointer);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glColorPointer(int size, uint type, int stride, float[] pointer);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glColorPointer(int size, uint type, int stride, double[] pointer);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glCopyPixels(int x, int y, int width, int height, uint type);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glCopyTexImage1D(uint target, int level, uint internalFormat, int x, int y,
            int width, int border);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glCopyTexImage2D(uint target, int level, uint internalFormat, int x, int y,
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glCopyTexSubImage2D(uint target, int level, int xoffset, int yoffset, int x, int y,
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glFrustum(double left, double right, double bottom, double top, double zNear,
            double zFar);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern unsafe sbyte* glGetString(uint name);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glGetTexLevelParameterfv(uint target, int level, uint pname,
            float[] params_notkeyword);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void
            glGetTexLevelParameteriv(uint target, int level, uint pname, int[] params_notkeyword);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glMap2d(uint target, double u1, double u2, int ustride, int uorder, double v1,
            double v2, int vstride, int vorder, double[] points);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glMap2f(uint target, float u1, float u2, int ustride, int uorder, float v1, float v2,
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glNormalPointer(uint type, int stride, short[] pointer);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glNormalPointer(uint type, int stride, int[] pointer);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glNormalPointer(uint type, int stride, float[] pointer);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glNormalPointer(uint type, int stride, double[] pointer);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glOrtho(double left, double right, double bottom, double top, double zNear,
            double zFar);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glReadPixels(int x, int y, int width, int height, uint format, uint type,
            byte[] pixels);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glTexImage1D(uint target, int level, uint internalformat, int width, int border,
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        private static extern void glTexSubImage1D(uint target, int level, int xoffset, int width, uint format,
            uint type, int[] pixels);
        ...
        private static extern unsafe sbyte* gluErrorString(uint errCode);

        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern unsafe sbyte* gluGetString(int name);
        ...
        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern void gluLookAt(double eyex, double eyey, double eyez, double centerx, double centery,
            double centerz, double upx, double upy, double upz);

        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern void gluProject(double objx, double objy, double objz, double[] modelMatrix,
            double[] projMatrix, int[] viewport, double[] winx, double[] winy, double[] winz);

        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern void gluUnProject(double winx, double winy, double winz, double[] modelMatrix,
            double[] projMatrix, int[] viewport, ref double objx, ref double objy, ref double objz);

        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern void gluScaleImage(int format, int widthin, int heightin, int typein, int[] datain,
            int widthout, int heightout, int typeout, int[] dataout);

        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern void gluBuild1DMipmaps(uint target, uint components, int width, uint format, uint type,
            IntPtr data);

        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern void gluBuild2DMipmaps(uint target, uint components, int width, int height, uint format,
        ...
        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern void gluCylinder(IntPtr qobj, double baseRadius, double topRadius, double height,
        ...
        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern void gluPartialDisk(IntPtr qobj, double innerRadius, double outerRadius, int slices,
...
//		[DllImport(LIBRARY_GLU, SetLastError = true)] private static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.VertexData callback);
        ...
        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern void gluNurbsCurve(IntPtr nobj, int nknots, float[] knot, int stride, float[] ctlarray,
            int order, uint type);

        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern void gluNurbsSurface(IntPtr nobj, int sknot_count, float[] sknot, int tknot_count,
            float[] tknot, int s_stride, int t_stride, float[] ctlarray, int sorder, int torder, uint type);

        [DllImport(LIBRARY_GLU, SetLastError = true)]
        private static extern void gluLoadSamplingMatrices(IntPtr nobj, float[] modelMatrix, float[] projMatrix,
            int[] viewport);
        ...
        public byte AreTexturesResident(int n, uint[] textures, byte[] residences){
            PreGLCall();
            var returnValue = glAreTexturesResident(n, textures, residences);
            PostGLCall();
        ...
        public void BlendFunc(Enumerations.BlendingSourceFactor sourceFactor,
            Enumerations.BlendingDestinationFactor destinationFactor){
            PreGLCall();
        ...
        /// <param name="stride">Specifies the byte offset between consecutive colors. If stride is 0, (the initial value), the colors are understood to be tightly packed in the array.</param>
        /// <param name="pointer">Specifies a pointer to the first component of the first color element in the array.</param>
        public unsafe void ColorPointer(int size, int stride, float* pointer){
            PreGLCall();
            glColorPointer(size, GL_FLOAT, stride, (IntPtr) pointer);
            PostGLCall();
        }
        ...
        /// <param name="stride">Specifies the byte offset between consecutive colors. If stride is 0, (the initial value), the colors are understood to be tightly packed in the array.</param>
        /// <param name="pointer">Specifies a pointer to the first component of the first color element in the array.</param>
        public unsafe void ColorPointer(int size, int stride, double* pointer){
            PreGLCall();
            glColorPointer(size, GL_DOUBLE, stride, (IntPtr) pointer);
            PostGLCall();
        }
        ...
        /// <param name="border">Specifies the width of the border. Must be either 0 or 1.</param>
        public void CopyTexImage2D(uint target, int level, uint internalFormat, int x, int y, int width, int height,
            int border){
            PreGLCall();
        ...
        /// <param name="width">Specifies the width of the texture image.</param>
        /// <param name="height">Specifies the height of the texture image.</param>
        public void CopyTexSubImage2D(uint target, int level, int xoffset, int yoffset, int x, int y, int width,
            int height){
            PreGLCall();
        ...
        /// <param name="count">Specifies the number of elements to be rendered.</param>
        /// <param name="indices">Specifies a pointer to the location where the indices are stored.</param>
        public unsafe void DrawElements(uint mode, int count, uint* indices){
            PreGLCall();
            glDrawElements(mode, count, GL_UNSIGNED_INT, (IntPtr) indices);
            PostGLCall();
        }
        ...
        /// <param name="points">The data for the points.</param>
        public void Map2(uint target, double u1, double u2, int ustride, int uorder, double v1, double v2, int vstride,
        ...
        /// <param name="vorder">The degree plus one.</param>
        /// <param name="points">The data for the points.</param>
        public void Map2(uint target, float u1, float u2, int ustride, int uorder, float v1, float v2, int vstride,
        ...
        /// <param name="stride">The space in bytes between each normal.</param>
        /// <param name="pointer">The normals.</param>
        public unsafe void NormalPointer(int stride, float* pointer){
            PreGLCall();
            glNormalPointer(GL_FLOAT, stride, (IntPtr) pointer);
            PostGLCall();
        }
        ...
        /// <param name="stride">The space in bytes between each normal.</param>
        /// <param name="pointer">The normals.</param>
        public unsafe void NormalPointer(int stride, double* pointer){
            PreGLCall();
            glNormalPointer(GL_DOUBLE, stride, (IntPtr) pointer);
            PostGLCall();
        }
        ...
        public void PartialDisk(IntPtr qobj, double innerRadius, double outerRadius, int slices, int loops,
        ...
        public void Project(double objx, double objy, double objz, double[] modelMatrix, double[] projMatrix,
        ...
        public int RenderMode(Enumerations.RenderingMode mode){
            PreGLCall();
            var hits = glRenderMode((uint) mode);
            PostGLCall();
            return hits;
        }
        ...
        /// <param name="zfail">Depth fail component.</param>
        /// <param name="zpass">Depth pass component.</param>
        public void StencilOp(Enumerations.StencilOperation fail, Enumerations.StencilOperation zfail,
            Enumerations.StencilOperation zpass){
            PreGLCall();
        ...
        public void TexImage1D(uint target, int level, uint internalformat, int width, int border, uint format,
            uint type, byte[] pixels){
            PreGLCall();
        ...
        /// <param name="type">The type of data you are passing, e.g GL_BYTE.</param>
        /// <param name="pixels">The actual pixel data.</param>
        public void TexImage2D(uint target, int level, uint internalformat, int width, int height, int border,
            uint format, uint type, byte[] pixels){
            PreGLCall();
        ...
        /// <param name="pname">The parameter to set.</param>
        /// <param name="parameters">The value to set it to.</param>
        public void TexParameter(Enumerations.TextureTarget target, Enumerations.TextureParameter pname,
            float[] parameters){
            PreGLCall();
        ...
        /// <param name="type">Specifies the data type of the pixel	data.</param>
        /// <param name="pixels">Specifies a pointer to the image data in memory.</param>
        public void TexSubImage2D(uint target, int level, int xoffset, int yoffset, int width, int height, uint format,
            uint type, int[] pixels){
            PreGLCall();
        ...
        public double[] UnProject(double winx, double winy, double winz){
            ...
            gluUnProject(winx, winy, winz, modelview, projection, viewport, ref result[0], ref result[1],
                ref result[2]);
        ...
        /// <param name="stride">The byte offset between vertices.</param>
        /// <param name="pointer">The array.</param>
        public unsafe void VertexPointer(int size, int stride, float* pointer){
            PreGLCall();
            glVertexPointer(size, GL_FLOAT, stride, (IntPtr) pointer);
            PostGLCall();
        }
        ...
        /// <param name="stride">The byte offset between vertices.</param>
        /// <param name="pointer">The array.</param>
        public unsafe void VertexPointer(int size, int stride, double* pointer){
            PreGLCall();
            glVertexPointer(size, GL_DOUBLE, stride, (IntPtr) pointer);
            PostGLCall();
        }
        ...
        public void ScaleImage(int format, int widthin, int heightin, int typein, int[] datain, int widthout,
            int heightout, int typeout, int[] dataout){
            PreGLCall();
        ...
        /// <param name="type">Specifies the data type for data.</param>
        /// <param name="data">Specifies a pointer to the image data in memory.</param>
        public void Build2DMipmaps(uint target, uint components, int width, int height, uint format, uint type,
            IntPtr data){
            PreGLCall();
        ...
        protected virtual void PreGLCall(){
            ...
            if (insideGLBegin == false) GetError();
#endif

            //  If we are not the current OpenGL object, make ourselves current.
            if (currentOpenGLInstance != this) MakeCurrent();
        }
        ...
        protected virtual void PostGLCall(){
            ...
            if (insideGLBegin == false){
                ...
                if (errorCode != GL_NO_ERROR){
                    ...
                    var functionName = stackFrames != null && stackFrames.Length > 1
                        ? stackFrames[1].GetMethod().Name
                        : "Unknown Function";
                    Trace.WriteLine("OpenGL Error: \"" + errorMessage + "\", when calling function SharpGL." +
                                    functionName);
                }
            }
#endif
        ...
        /// <returns></returns>
        public virtual bool Create(OpenGLVersion openGLVersion, RenderContextType renderContextType, int width,
            int height, int bitDepth, object parameter){
        ...
        /// True on success
        /// </returns>
        public virtual bool CreateFromExternalContext(OpenGLVersion openGLVersion, int width, int height, int bitDepth,
            IntPtr windowHandle, IntPtr renderContextHandle, IntPtr deviceContextHandle){
            // Return if we don't have a sensible width or height.
            if (width == 0 || height == 0 || bitDepth == 0) return false;
        ...
        public IRenderContextProvider RenderContextProvider => renderContextProvider;

        /// <summary>
        /// Gets the vendor.
        /// </summary>
        /// <value>The vendor.</value>
        public string Vendor => GetString(GL_VENDOR);

        /// <summary>
        /// Gets the renderer.
        /// </summary>
        /// <value>The renderer.</value>
        public string Renderer => GetString(GL_RENDERER);

        /// <summary>
        /// Gets the version.
        /// </summary>
        /// <value>The version.</value>
        public string Version => GetString(GL_VERSION);

        /// <summary>
        /// Gets the extensions.
        /// </summary>
        /// <value>The extensions.</value>
        public string Extensions => GetString(GL_EXTENSIONS);
