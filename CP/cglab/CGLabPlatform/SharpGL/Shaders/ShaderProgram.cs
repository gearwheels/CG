...
namespace SharpGL.Shaders{
    public class ShaderProgram{
        ...
        public void Create(OpenGL gl, string vertexShaderSource, string fragmentShaderSource,
            ...
            if (attributeLocations != null)
                foreach (var vertexAttributeLocation in attributeLocations)
                    gl.BindAttribLocation(shaderProgramObject, vertexAttributeLocation.Key,
                        vertexAttributeLocation.Value);
            ...
            if (GetLinkStatus(gl) == false)
                throw new ShaderCompilationException(
                    string.Format("Failed to link shader program with ID {0}.", shaderProgramObject), GetInfoLog(gl));
        }
        ...
        /// </value>
        public uint ShaderProgramObject => shaderProgramObject;
