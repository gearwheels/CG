...
namespace SharpGL{
    ...
    public static class Win32{
        ...
        static Win32(){
            ...
            var glLibrary = LoadLibrary(OpenGL32);
        }
        ...
        public static extern bool wglUseFontOutlines(IntPtr hDC, uint first, uint count, uint listBase,
            ...
            [Out] [MarshalAs(UnmanagedType.LPArray)] GLYPHMETRICSFLOAT[] lpgmf);
        ...
        public class PIXELFORMATDESCRIPTOR{
            [FieldOffset(0)] public ushort nSize;
            [FieldOffset(2)] public ushort nVersion;
            ...
            [FieldOffset(28)] public uint dwLayerMask;
            [FieldOffset(32)] public uint dwVisibleMask;
            [FieldOffset(36)] public uint dwDamageMask;
        ...
        public static extern unsafe int ChoosePixelFormat(IntPtr hDC,
            [In] [MarshalAs(UnmanagedType.LPStruct)]
            PIXELFORMATDESCRIPTOR ppfd);

        [DllImport(Gdi32, SetLastError = true)]
        public static extern unsafe int SetPixelFormat(IntPtr hDC, int iPixelFormat,
            [In] [MarshalAs(UnmanagedType.LPStruct)]
            PIXELFORMATDESCRIPTOR ppfd);
