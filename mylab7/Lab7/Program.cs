...
public abstract class MyApp : OGLApplicationTemplate<CGApplication>{
    ...
    [DisplayNumericProperty(0.01, Minimum: 0.005, Maximum: 1.0, Increment: 0.005, Name: "dt")]
    public abstract float dt{ get; set; }

    [DisplayNumericProperty(new[]{-0.5d, -0.5d}, 0.05, "P0")]
    public abstract DVector2 P0{ get; set; }

    [DisplayNumericProperty(new[]{-0.5d, 0.5d}, 0.05, "P1")]
    public abstract DVector2 P1{ get; set; }

    [DisplayNumericProperty(new[]{0.5d, 0.5d}, 0.05, "P2")]
    ...
    protected override unsafe void OnMainWindowLoad(object sender, EventArgs args){
        ...
        RenderDevice.MouseUp += (s, e) => { selectedPoint = null; };
