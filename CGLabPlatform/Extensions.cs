...
namespace CGLabPlatform{
    public static class Extensions{
        ...
        private static Func<Ectx, Sctx> __get = arg => {
        ...
        public static void DrawString(this Graphics graphics, string s, Font font, Brush brush, double x, double y){
            unchecked{
                ...
                graphics.DrawString(s, font, brush, (int) (x < 0 ? x - 0.5 : x + 0.5),
                    (int) (y < 0 ? y - 0.5 : y + 0.5));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void FillRectangle(this BitmapSurface surface, int color, int sx, int sy, int width,
            int height){
            unchecked{
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void DrawLine(this BitmapSurface surface, int color, double x1, double y1, double x2,
            double y2){
            unchecked{
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void DrawTriangle(this BitmapSurface surface, int color, double x1, double y1, double x2,
            ...
            unchecked{
                ...
                switch (trimed){
                    case 11:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x3, y3, x1, y1, x4, y4);
                        return;
                    case 13:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x2, y2, x0, y0, x5, y5);
                        return;
                    case 14:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x1, y1, x2, y2, x3, y3);
                        return;
                    case 1:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x2, y2, x3, y3, x0, y0);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x3, y3, x0, y0, x1, y1);
                        return;
                    case 2:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x1, y1, x3, y3, x4, y4);
                    ...
                    case 4:
                        ...
                        return;
                    case 3:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x3, y3, x1, y1, x0, y0);
                        ...
                        return;
                    case 5:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x2, y2, x0, y0, x1, y1);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x2, y2, x1, y1, x3, y3);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x2, y2, x3, y3, x5, y5);
                        return;
                    case 6:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x1, y1, x2, y2, x4, y4);
                    ...
                    case 15:
                    case 7:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color, x0, y0, x1, y1, x3, y3);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void DrawTriangle(this BitmapSurface surface, int color1, double x1, double y1, int color2,
            double x2, double y2, int color3, double x3, double y3){
            unchecked{
                if (surface.Clipper.PointsInBounds(x1, y1, x2, y2, x3, y3)){
                    Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color1, x1, y1, color2, x2, y2,
                        color3, x3, y3);
                    return;
                }
                ...
                switch (trimed){
                    case 11:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color3, x3, y3, c1, x1, y1, c4,
                            x4, y4);
                        return;
                    case 13:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color2, x2, y2, c0, x0, y0, c5,
                            x5, y5);
                        return;
                    case 14:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color1, x1, y1, c2, x2, y2, c3,
                            x3, y3);
                        return;
                    case 1:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color2, x2, y2, color3, x3, y3,
                            c0, x0, y0);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color3, x3, y3, c0, x0, y0, c1,
                            x1, y1);
                        return;
                    case 2:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color1, x1, y1, color3, x3, y3,
                            c4, x4, y4);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color1, x1, y1, c4, x4, y4, c2,
                            x2, y2);
                        return;
                    case 4:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color1, x1, y1, color2, x2, y2,
                            c3, x3, y3);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color2, x2, y2, c3, x3, y3, c5,
                            x5, y5);
                        return;
                    case 3:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color3, x3, y3, c1, x1, y1, c0,
                            x0, y0);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color3, x3, y3, c0, x0, y0, c2,
                            x2, y2);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color3, x3, y3, c2, x2, y2, c4,
                            x4, y4);
                        return;
                    case 5:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color2, x2, y2, c0, x0, y0, c1,
                            x1, y1);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color2, x2, y2, c1, x1, y1, c3,
                            x3, y3);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color2, x2, y2, c3, x3, y3, c5,
                            x5, y5);
                        return;
                    case 6:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color1, x1, y1, c2, x2, y2, c4,
                            x4, y4);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color1, x1, y1, c4, x4, y4, c5,
                            x5, y5);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, color1, x1, y1, c5, x5, y5, c3,
                            x3, y3);
                        return;
                    case 15:
                    case 7:
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, c0, x0, y0, c1, x1, y1, c3, x3,
                            y3);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, c0, x0, y0, c2, x2, y2, c4, x4,
                            y4);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, c0, x0, y0, c3, x3, y3, c5, x5,
                            y5);
                        Drawing.DrawTriangleLQ((int*) surface.ImageBits, surface.Width, c0, x0, y0, c4, x4, y4, c5, x5,
                            y5);
                        return;
                    default: throw new NotImplementedException();
                }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void QuickSort<T>(this IList<T> input, Func<T, double> getkey, int index = 0,
            int length = -1){
            unchecked{
                ...
                T input_temp;
                var input_length = length < 0 ? input.Count : length;
                ...
                for (var pi = input_length; 0 != pi--; --depth) *depth = getkey(input[pi]);
                ++depth;
    ...
    public static class HelpUtils{
        ...
        public static Image GetImageFromRes(string directory, string filename, string extension,
            Assembly assembly = null){
            return Image.FromStream(GetStreamFromRes(directory, filename, extension, assembly));
        }

        public static Image GetImageFromRes(string name, Assembly assembly = null){
            return Image.FromStream(GetStreamFromRes(name, assembly));
        }

        public static string GetTextFileFromRes(string directory, string filename, string extension,
            Assembly assembly = null){
            return GetTextFileFromRes(directory, filename, extension, Encoding.UTF8, assembly);
        }

        public static string GetTextFileFromRes(string directory, string filename, string extension, Encoding encoding,
            Assembly assembly = null){
        ...
        public static Stream GetStreamFromRes(string directory, string filename, string extension,
            Assembly assembly = null){
        ...
        public static Stream GetStreamFromRes(string name, Assembly assembly = null){
            ...
            if (string.IsNullOrEmpty(resname))
                throw new Exception(string.Format("Запрашиваемый файл ресурсов \"{0}\" в сборке \"{1}\" не найден",
        ...
        private static string GetInternalResourceName(string resourceName, ref Assembly resourceAssembly){
            ...
            var rootnamespace = string.Join(".", resourcenames
                .Select(n => n.Split('.')).Aggregate((r, n) => {
                    for (var i = 0; i < Math.Min(r.Length, n.Length); ++i)
                        if (r[i] != n[i])
                            return r.Take(i).ToArray();
                    return r;
                }));
            var searchresname = new List<string>(rootnamespace.Split('.'));
            for (var i = searchresname.Count - 1; i >= 0; --i)
            ...
            var foundresname = searchresname.Select(n => string.Format("{0}.{1}", n, resourceName))
                .Intersect(resourcenames).ToList();
    ...
    public sealed class QueueSynchronizationContext : SynchronizationContext{
        ...
        public void Run(Task task){
            var currentThreadId = Thread.CurrentThread.ManagedThreadId;
            if (currentThreadId != targetThreadId) throw new InvalidOperationException();
